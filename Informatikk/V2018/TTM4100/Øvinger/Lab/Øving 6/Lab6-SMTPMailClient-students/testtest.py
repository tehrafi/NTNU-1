...
base64_str = (base64.encodestring(username.encode())+base64.encodestring(username.encode()))
'''
username = base64.b64encode(bytes(username, 'UTF-8'))
username = base64.b64encode(bytes(password, 'UTF-8'))
'''
#print("Base 64 str: " + base64_str)
