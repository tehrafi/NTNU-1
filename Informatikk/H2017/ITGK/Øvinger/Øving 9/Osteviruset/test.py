...
print(cheeses.get("port salut"))

shelves = ['B13', 'B14', 'B15', 'A234', 'A235', 'C31']
infected_cheeses = []

for key in cheeses.items():
    for value1 in shelves:
        if value1 not in cheeses.get(key):
            continue
        else:
            infected_cheeses.append(key)

print("Potentional infected cheeses: " + str(infected_cheeses))
