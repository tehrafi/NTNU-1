...
def string_2_key(streng):
    ...
    # TO BE DONE: skriv koden som regner ut et nøkkeltall for ordet
    # som fins i parameteren streng og returnerer dette tallet
...
def list_2_dic(liste):
    ...
    # TO BE DONE: skriv ei løkke som går igjennom liste
    # og lager en dictionary hvor alle ordene er plassert inn
    # på sine respektive nøkler funnet med string_2_key()
    return dic
...
# for alle bokstavene i et ord vil ord få med samme verdi hvis og bare hvis de
